...
public class NamesReader {
    ...
    private void loadInvalidElements() {
        invalid.add(document.select(".namesList .vengtini .fName, .namesList .vengtini .mName"));
        invalid.add(document.select(".namesList .nevartotini .fName, .namesList .nevartotini .mName"));
    }
